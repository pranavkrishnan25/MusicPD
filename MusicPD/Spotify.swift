...
final class Spotify: ObservableObject {
    ...
    static let loginCallbackURL = URL(
        string: "music-pd://login-callback"
    )!
    ...
    private let keychain = Keychain(service: "com.yashpatel.MusicPD")
    ...
    func authorize() {
        ...
        let authorizationURL = api.authorizationManager.makeAuthorizationURL(
            ...
            scopes: [
                .userReadPlaybackState, .userReadEmail, .userLibraryModify, .userModifyPlaybackState, .userTopRead
            ]
        )!
